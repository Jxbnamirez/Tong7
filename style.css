// คลังคำถามดาราศาสตร์และอวกาศ (อัปเดตเป็น 10 ข้อ)
const quizData = [
    {
    ...
    {
        question: "3. แสงจากดวงอาทิตย์ใช้เวลาเดินทางมาถึงโลกประมาณกี่นาที?",
    ...
    {
        question: "6. ดาวเคราะห์ดวงใดที่มีฉายาว่า 'ดาวเคราะห์แดง' เนื่องจากพื้นผิวเต็มไปด้วยออกไซด์ของเหล็ก (สนิมเหล็ก)?",
        options: ["ดาวพุธ", "ดาวอังคาร", "ดาวเสาร์", "ดาวเนปจูน"],
        correct: 1
    },
    {
        question: "7. ดาวเคราะห์ชั้นนอกดวงใดที่มีวงแหวนขนาดใหญ่และมองเห็นได้ชัดเจนที่สุดจากโลก?",
        options: ["ดาวพฤหัสบดี", "ดาวเสาร์", "ดาวยูเรนัส", "ดาวเนปจูน"],
        correct: 1
    },
    {
        question: "8. สิ่งใดที่อยู่ใจกลางของกาแล็กซีทางช้างเผือกและมีแรงโน้มถ่วงมหาศาลจนแม้กระทั่งแสงก็ไม่สามารถหนีออกมาได้?",
        options: ["หลุมดำมวลยิ่งยวด", "ดาวนิวตรอน", "เนบิวลา", "ดาวแคระขาว"],
        correct: 0
    },
    {
        question: "9. ดาวดวงใดคือ 'ดาวเหนือ' (Polaris) ซึ่งเป็นดาวที่มนุษย์ใช้ในการหาทิศเหนือมาตั้งแต่อดีต?",
        options: ["ดาวซิริอุส (ดาวโจร)", "ดาวเวกา", "ดาวโพลาริส", "ดาวหางฮัลเลย์"],
        correct: 2
    },
    {
        question: "10. ยานอวกาศลำแรกที่พามนุษย์ไปลงจอดบนดวงจันทร์ในโครงการ Apollo 11 มีชื่อว่าอะไร?",
        options: ["ยานวอยเอเจอร์ 1", "ยานสปุตนิก 1", "ยานอพอลโล 11", "ยานคิวริออซิตี"],
        correct: 2
    }
];
